...
export default function Sidebar() {
  return (
    <div className="fixed top-0 left-0 w-[120px] h-screen bg-[#f5f5f5] ggi:hidden z-[4999]">
      <div className="flex flex-col absolute top-[108px] left-1/2 -translate-x-1/2 p-[20px] bg-white items-center justify-center rounded-[24px] gap-[40px]">
        <Link href="/data-pro">
          <HomeIcon />
        </Link>
        <Link href="/">
