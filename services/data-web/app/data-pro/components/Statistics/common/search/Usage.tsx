  ...
  return (
    <div className="flex flex-col h-[100px] w-[50%] gap-[12px]">
      ...
      <div className="flex flex-row h-[50px] gap-[8px] w-full">
        <div className="relative inline-block text-left flex-1 rounded-full h-full border border-[#e5e7eb] pr-[16px] pl-[16px] ">
        ...
        <div className="relative inline-block text-left flex-1 border rounded-full h-full border-[#e5e7eb] pr-[16px] pl-[16px]">
          <select className="peer block appearance-none w-full p-1 rounded-full bg-white h-full focus:outline-none">
            <option value="">Option 1</option>
            <option value="">Option 2</option>
            <option value="">Option 3</option>
